    ...
    return (
        <div className='w-screen overflow-x-scroll text-red-500'>
                ...
                {/* single item  */}
            {
                ...
                <div key={item.id} className='w-screen p-4 h-[60vh] flex flex-col items-center justify-around hover:bg-fuchsia-50 transition-all duration-300 md:w-[50vw] lg:w-[33vw]'>
                {/* image container */}
